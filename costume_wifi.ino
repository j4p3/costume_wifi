...
#ifndef STASSID
#define STASSID "jp's costume lmao"
#endif
...
server.onNotFound([]() {
  if(!handleFileRead(server.uri())){
    const char *metaRefreshStr = "<head><meta http-equiv=\"refresh\" content=\"0; url=http://192.168.4.1/index.html\" /></head><body><p>whoops</p></body>";
